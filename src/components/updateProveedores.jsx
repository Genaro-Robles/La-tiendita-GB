...
export default function UpdateProveedores({ id, getProveedores, setData }) {
    async function getProveedoresId(id) {
    ...
    async function updateProveedores(data, id) {
        try {
            await axios.put("http://localhost:8080/provider/" + id, data),
                {
                    headers,
                };
        } catch (error) {
                                    ...
                                    <form onSubmit={onSubmit}>
                                        ...
                                        <div className="flex flex-col py-3">
                                            ...
                                            <input
                                                ...
                                                defaultValue={proveedores.address}
                                                {...register("address")}
                                            />
                                        </div>
                                        <div className="flex flex-col py-3">
                                        ...
                                        <div className="flex flex-col py-3">
                                            ...
                                            <input
                                                ...
                                                defaultValue={proveedores.phone}
                                                {...register("phone")}
                                            />
                                        </div>
