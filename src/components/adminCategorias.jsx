...
import UpdateCategorias from "@/components/updateCategoria";
...
export default function AdminCategorias() {
    ...
    async function renewCategorias(id) {
        try {
            await axios.patch("http://localhost:8080/category/" + id, {
                headers,
            });
        } catch (error) {
            console.log("error " + error);
    ...
    return (
        <>
            <button
                ...
                onClick={open}
            >
                <span className="text-xl font-semibold">Crear Categorias</span>
            ...
            <table className="table-fixed">
                ...
                <tbody>
                    {data.map((categoria, index) => (
                        ...
                        >
                            <td className="px-5">{categoria.id}</td>
                            <td className="px-2">{categoria.name}</td>
                            <td className="px-2">{categoria.description}</td>
                            <td className="px-2">
                                <UpdateCategorias
                                    id={categoria.id}
                                    setData={setData}
